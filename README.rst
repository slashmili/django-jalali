...
This code will get the start time of the server it may be usable for development but rather it is suggested to use the following code to get dynamic date result:
